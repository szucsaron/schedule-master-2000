...
public interface CouponService {
    ...
    List<Coupon> getCoupons(User user, Shop shop) throws SQLException;


    Coupon getCoupon(String id) throws SQLException, ServiceException;

    Coupon addCoupon(User user, String name, String percentage) throws SQLException, ServiceException;
