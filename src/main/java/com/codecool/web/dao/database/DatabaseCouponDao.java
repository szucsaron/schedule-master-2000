...
public final class DatabaseCouponDao extends AbstractDao implements CouponDao {
    ...
    @Override
    public List<Coupon> find(int userId) throws SQLException {
        String sql = "SELECT id, name, percentage FROM coupons  WHERE user_id = ?";
    ...
    @Override
    public Coupon add(String name, int usedId, int percentage) throws SQLException {
